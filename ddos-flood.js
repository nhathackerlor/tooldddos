...
if (cluster.isMaster) {
	console.clear()
	console.log(` SẮP DIE WED `.bgGreen)
	console.log(` DDOS VIP `.bgGreen)
	, console.log(` `.yellow)
	, console.log(`TARGET: ${process.argv[2]}`.bgBlue)
	, console.log(`TIME: ${process.argv[3]}`.bgRed)
	, console.log(`THREAD: ${process.argv[4]}`.bgBlue)
	, console.log(`PROXYFILE: ${process.argv[5]}`.bgYellow)
	, console.log(`RPS: ${process.argv[6]}`.bgGreen)
	, console.log(` `.yellow)
